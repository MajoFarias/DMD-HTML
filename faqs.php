...
<section class="headerIn" style="background: url('assets/images/headerIn.jpg') center;">
	<article class="text containerIn">
		<h1 class="white" data-scrollreveal="enter up">Soporte Técnico</sup></h1>
	</article>
</section>

<section class="containerIn">
<div class="row tree">
	<a href="index.php">Soporte Técnico</a><i class=""> /</i>
	<a href="faqs.php">Faqs</a>
</div>
</section>

<section class="containerIn generica">
	<h1 class="lineTitle animated fadeIn">Faq's</h1>
	
</section>

<section class="containerIn">
<article class="cd-faq">
	<ul class="cd-faq-categories">
		<li><a class="selected" href="#basics">Comunes</a></li>
		<li><a href="#mobile">Celular</a></li>
	...
	<div class="cd-faq-items">
		<ul id="basics" class="cd-faq-group">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">¿Cómo cambio mi contraseña?</a>
			...
			<li>
				<a class="cd-faq-trigger" href="#0">¿Cómo creo una cuenta?</a>
				<div class="cd-faq-content">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">¿Cómo puedo remover un comentario?</a>
				<div class="cd-faq-content">
		...
		<ul id="mobile" class="cd-faq-group">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">Como subo archivos desde al celular?</a>
				<div class="cd-faq-content">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">¿Cómo publico?</a>
				<div class="cd-faq-content">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">¿Lorem Ipsum?</a>
				<div class="cd-faq-content">
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
				</div> <!-- cd-faq-content -->
			</li>
